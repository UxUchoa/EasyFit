    ...
    <form onSubmit={submit} className="mt-8">
      ...
      <fieldset className={step === 1 ? "grid gap-5" : "hidden"} disabled={step !== 1}>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          <div className="field min-w-0 max-w-full overflow-hidden"><label htmlFor="birthDate">Data de nascimento</label><input className="mobile-date-control" id="birthDate" name="birthDate" type="date" autoComplete="bday" required /></div>
